...
public class CenterPanel extends JPanel {
	...
	public void createLabels() {
		...
		for (int i = 0; i < ballLabels.length; i++) {
			ballLabels[i] = new JLabel(
					ball);
			ballLabels[i].setHorizontalTextPosition(
					JLabel.CENTER);
			ballLabels[i].setVerticalTextPosition(
					JLabel.CENTER);
		}
	...
	public void createButtons() {
		quickPickButton = new JButton(
				"Quick Pick First 5 Numbers");
		quickPickButton.addActionListener(
				new ActionListener() {
		...
		powerBallButton = new JButton(
				"Quick Pick Powerball Number");
		powerBallButton.addActionListener(
				new ActionListener() {
					public void actionPerformed(
							ActionEvent e) {
